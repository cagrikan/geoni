...
export default async function handler(req, res) {
  ...
  const L = lang === 'tr' ? {
    ...
    h1: 'AI Friendly Ligi',
    sub: 'ChatGPT, Claude, Gemini ve Perplexity\'nin en iyi tanıdığı siteler. 70+ skor yapan herkes "AI Friendly · Checked by GEONI" mührünü kullanmaya hak kazanır ve bu listede yerini alır.',
    ...
    cta_p: 'Sitenin AI görünürlüğünü dakikalar içinde ücretsiz ölç. 70\'i geçersen mühür ve ligdeki yerin hazır.',
    ...
    sub: 'The sites ChatGPT, Claude, Gemini and Perplexity know best. Score 70+ and you earn the right to use the "AI Friendly · Checked by GEONI" seal — and your place on this board.',
    ...
    cta_p: 'Measure your site\'s AI visibility free in minutes. Cross 70 and the seal — and your spot here — is yours.',
    cta_btn: 'Scan Free →',
