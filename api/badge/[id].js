...
export default async function handler(req, res) {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="232" height="44" role="img" aria-label="AI Visibility Score: ${score}/100">
  <title>${label} — AI Visibility Score ${score}/100 · geoni.ai</title>
  <defs>
  ...
  <g clip-path="url(#r)">
    ...
    <text x="46" y="18" font-family="-apple-system,Segoe UI,Helvetica,Arial,sans-serif" font-size="10.5" fill="#A8ADC4" letter-spacing=".4">AI VISIBILITY SCORE</text>
    ...
    <text x="196" y="29" text-anchor="middle" font-family="-apple-system,Segoe UI,Helvetica,Arial,sans-serif" font-size="19" font-weight="800" fill="${color}">${score}</text>
  </g>
</svg>`;
